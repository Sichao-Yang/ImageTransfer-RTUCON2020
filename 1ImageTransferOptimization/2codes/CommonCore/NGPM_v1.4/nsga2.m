...
pop = repmat( struct(...
    'var', zeros(1,opt.numVar), ...
    'obj', zeros(1,opt.numObj), ...
    'cons', zeros(1,opt.numCons),...
    'rank', 0,...
    'distance', 0,...
    'prefDistance', 0,...       % preference distance used in R-NSGA-II
    'nViol', 0,...
    'violSum', 0,...
    'add', zeros(1,opt.numAdd)),...
    [1,popsize]);  %    'add', zeros(1,opt.numAdd),...
...
opt = callOutputfuns(opt, state, pop, varargin{:});
toc
%*************************************************************************
% NSGA2 iteration
%*************************************************************************

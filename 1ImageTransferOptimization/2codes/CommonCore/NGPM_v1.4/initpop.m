...
if(opt.numVar~=col)
    error('The number of variables is not matched between the old results and this optimisation!');
end
if(opt.popsize~=row)
    error('The population size is not matched between the old results and this optimisation!');
end
